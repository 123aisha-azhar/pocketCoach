...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: YourPocketCoachWidget.routeName,
          path: YourPocketCoachWidget.routePath,
          builder: (context, params) => YourPocketCoachWidget(),
        ),
        FFRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/View_recent_photos.png',
                    fit: BoxFit.contain,
                  ),
                )
              : page;
